...
void BrushLibrary::Init()
{
	...
	pComputeShader basic_brush_shader = theResourceFactory.LoadComputeShader("Resources/Shaders/BrushBasicShader.hlsl");
	...
	pComputeShader noise_brush_shader = theResourceFactory.LoadComputeShader("Resources/Shaders/BrushNoiseShader.hlsl");
	pBrush noise_brush = MAKE_NEW(Brush);
	noise_brush->Init(noise_brush_shader);
	AddBrush("Noise", noise_brush);

	pComputeShader smooth_brush_shader = theResourceFactory.LoadComputeShader("Resources/Shaders/BrushSmoothShader.hlsl");
