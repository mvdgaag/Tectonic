...
void SimpleHeightFlow::Init(pTerrain inTerrain)
{
	...
	mUpdateShader = theResourceFactory.LoadComputeShader("Resources/Shaders/UpdateSimpleHeightFlow.hlsl");
	mUpdateBorderShader = theResourceFactory.LoadComputeShader("Resources/Shaders/UpdateSimpleHeightFlowBorder.hlsl");
